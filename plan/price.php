<?php
    $title = '医療脱毛の料金一覧 | 天王寺・モアナスキンクリニック';
    $description = '全身1回23,000円、VIO1回25,000円、顔1回20,000円。お得な組み合わせプラン・複数回プランの料金もご案内します。｜天王寺で医療脱毛するなら天王寺駅前１分のモアナスキンクリニック';
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [{
        ...
        "position": 2,
        "name": "医療脱毛の料金一覧",
        "item": "https://www.moana-skin-clinic.com/plan/price"
    }]
}
</script>
</head>
